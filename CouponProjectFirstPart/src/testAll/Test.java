 ...
 */
	public static void testAll() {
		...
		try {
			...
			LocalDate a = LocalDate.of(2011, 12, 24);
			LocalDate b = LocalDate.of(2020, 12, 24);

			Coupon firstCoupon = new Coupon(Category.ELECTRICITY, "google food", "you eat it", a, b, 5, 49.90, "jijifjie");
			Coupon secondCoupon = new Coupon(Category.FASHION, "google food2", "you eat it", a, b, 5, 29.90, "jijifjie");
			Coupon thirdCoupon = new Coupon(3, Category.FOOD, "google food3", "you google it", a, b, 8, 19.90, "fwfewh");
			...
			Customer customer1 = new Customer("roy", "haik", "eitan@gmail.com", "2468", EmptyCouponArr);
			...
			secondCoupon.setTitle("updatedTitle");
			secondCoupon.setImage("updatedImage");
			companyFacade.updateCoupon(secondCoupon);
